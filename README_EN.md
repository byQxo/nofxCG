...
<div align="center">
  ...
  <p>🏠 Self-hosted first · 🔐 Offline admin login · 🗝️ Local root keys · ♻️ Recoverable ops · 🤝 Open to contributors</p>
</div>

> This repository is an independent derivative of [NOFX](https://github.com/NoFxAiOS/nofx). It is not the official upstream release.

- Current repository: [byQxo/nofxCG](https://github.com/byQxo/nofxCG)
- Upstream repository: [NoFxAiOS/nofx](https://github.com/NoFxAiOS/nofx)
...
If you want to contact the maintainer directly for feedback, discussion, or collaboration, use the WeChat contact QR code below.

If you find this fork useful, you are also welcome to support ongoing maintenance and development through the reward QR code.

<table>
  <tr>
    <td align="center" width="50%">
      <img src="Photo/Developer%20Contact%20Information.jpg" alt="developer contact QR code" width="88%" />
      <br />
      <sub>Developer contact: discussion, feedback, and collaboration</sub>
    </td>
    <td align="center" width="50%">
      <img src="Photo/WeChat%20Reward%20Code.jpg" alt="WeChat reward QR code" width="88%" />
      <br />
      <sub>Voluntary support only, used to help sustain maintenance and development</sub>
    </td>
  </tr>
</table>
